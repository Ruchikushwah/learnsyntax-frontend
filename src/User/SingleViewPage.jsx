  ...
  return (
    ...
    <div className="max-w-screen-xl mx-auto">
      <Helmet>
        ...
        <meta name="description" content={parse(record.description)} />
      </Helmet>
      {/* Course Banner */}
        ...
        <div className="w-full lg:w-1/3 bg-white p-4 sm:p-6 rounded-md shadow-2xl">
          ...
          <ul className="space-y-4  overflow-y-auto">
            {chapters.map((chapter) => (
              ...
              >
                <Helmet>
                  <title>{selectedChapter?.chapter_name}</title>
                  <meta name="description" content={parse(selectedChapter?.chapter_description)} />
                </Helmet>
