...
const AllContents = () => {
  ...
  {selectedTopic ? (
    <div>
      <h2 className="text-2xl font-bold text-gray-800 mb-4">{selectedTopic.topic_name}</h2>
      {selectedTopic.post && selectedTopic.post.length > 0 ? (
        ...
        <p className="text-gray-500 text-center">No posts available in this topic.</p>
      )}
    </div>
  ) : (
